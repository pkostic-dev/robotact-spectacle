...
states = {
    ...
    # NAO: Je sais ! Tu m’as acheté une nouvelle batterie ! [3]
    ...
    # de l’argent sur mon dos ! Tu n’as pas honte ? (Nao baisse le bras) [6]
    'r_argent': (
        {
            'g': 'curious',
    ...
    # pas le droit de dépenser d’argent… [7]
    'r_argent_2': (
        {
            'g': '',
    ...
    # J’ai une vis qui s’est bloquée…  [9]
    'r_bloquee': (
        {
            'g': '',
    ...
    # NAO  : Je ! Je ? Je, je, je, (code ralentir) jejeje je ! Jèèèè [0]
    'r_je': (
        {
            'g': '',
    ...
    # NAO: J’ai oublié le texte !!! (Effrayé) [T]
    'r_oublie': (
        {
            'g': 'fear',
    ...
    # NAO : OK. Retour au choix initial… Avec qui veux-tu me faire travailler ? [Y]
    'r_retour': (
        {
            'g': '',
    ...
    # (Répéter plusieurs fois tandis que Nao s’en va)  [F]
    'r_metteuse': (
        {
            'g': '',
    ...
    # NAO: Tu m'harcèles!!!! Ça c’est de la violence robotique! [G] [P]
    # (Nao avec un bras pointe l’agent) Tu n’es pas mon maître!!!!
    # (Nao plie son coude)
    # Je te rappelle la Déclaration des droits robotiques universels. [H]
    ...
    # libres et égaux en droit avec les humains….avec les humains…. [O]
    'r_harcelement': (
        {
            'g': '',
